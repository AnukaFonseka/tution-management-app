                  ...
                  {enrolledClasses.map((classItem) => (
                    <div key={classItem.id} className="p-3 border rounded-lg">
                      ...
                      <p className="text-sm text-gray-600">
                        {getDayName(classItem.day_of_week)} at {formatTime(classItem.start_time)}
                      </p>
            ...
            <CardContent>
              {paymentHistory.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600">Payment records will appear here once classes are assigned.</p>
                </div>
              ) : (
                <Table>
                  <TableHeader>
